<template>
    <div id="app">
        <v-app id="inspire">
            ...
            <p></p>
            <p class="text-center">
                Estes são os membros atuais da casa em questão:
            </p>
            <form>
                <v-row justify="center">
                    <v-card color="#404040" dark height="50%" width="20%">
                        <v-card-title class="headline justify-center">
                            ♛ Membro 1</v-card-title
                        >
                    </v-card>
                </v-row>
                <br />
